...
class EmailConfirmationContainer extends Component {
  ...
  render() {
    const { isLoading, isVerified, tokenExpired, resendConfirmEmail } = this.props
...
const mapDispatchToProps = dispatch => bindActionCreators({ confirmEmail, resendConfirmEmail }, dispatch)
